...
from config.config import TAPConfig
args = TAPConfig()
...
# subsampled_sequence_length => traj_length
...
model_config = utils.Config(
    ...
    ## discretization
    vocab_size=args.vocab_size, block_size=block_size,
    K=args.n_tokens,
    ## architecture
    ...
    trajectory_embd=args.traj_emb_dim,
    model=args.model,
